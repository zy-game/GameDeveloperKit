...
namespace GameDeveloperKit.Story.Playback
{
    ...
    {
        public static PlayerView CreateDefault(Transform parent = null)
        {
            var rootObject = new GameObject("PlayerView", typeof(RectTransform));
            ...
            var view = rootObject.AddComponent<PlayerView>();
