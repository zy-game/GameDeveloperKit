...
namespace RenderHeads.Media.AVProVideo.Editor
{
	...
	public partial class MediaPlayerEditor : UnityEditor.Editor
	{
		...
		private readonly static FieldDescription _optionMaxDropMode = new FieldDescription(".maxDropMode", new GUIContent("Maximum Drop Mode", "How aggressive frame dropping should be with 0 = no frame dropping, 5 = maximum permitted"));
				...
				}
				{
					...
					if (_showUltraOptions)
					{
						...
						if (useHapNotchLC.boolValue)
						{
							...
							DisplayPlatformOption(optionsVarName, _optionMaxDropMode);
							EditorGUI.indentLevel--;
						}
					}
				}
