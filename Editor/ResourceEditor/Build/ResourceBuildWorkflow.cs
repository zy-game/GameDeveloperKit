...
namespace GameDeveloperKit.ResourceEditor
{
    ...
    public sealed class ResourceBuildWorkflow
    {
        ...
        internal bool TryPrepare(out ResourceBuildPreparedRequest request, out string error)
        {
            request = null;
            ...
            var context = new ResourceBuildContext(
                ...
                buildTime,
                target);
            request = new ResourceBuildPreparedRequest(this, context, plan);
            error = null;
            return true;
        }

        internal ResourceBuildResult Build(ResourceBuildPreparedRequest request)
        {
            if (request == null)
            {
            ...
            return ResourceBuildExecutor.Build(request.Context, request.Plan);
        }
