...
namespace GameDeveloperKit.StoryEditor.Excel
{
    ...
    public static class Exporter
    {
        ...
        private static void BuildChapterDefineSheet(ExcelPackage package, IReadOnlyList<AuthoringChapter> chapters)
        {
        ...
        private static void BuildChapterDataSheet(
            ...
            string storyId,
            IReadOnlyList<AuthoringChapter> chapters)
        {
        ...
        private static string BuildArgsCell(AuthoringNode node)
        {
            ...
            var sorted = new List<AuthoringParameter>(parameters);
