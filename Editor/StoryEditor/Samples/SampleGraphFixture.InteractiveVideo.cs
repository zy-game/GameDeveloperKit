...
namespace GameDeveloperKit.StoryEditor.Model
{
    public static partial class SampleGraphFixture
    {
        ...
        private static AuthoringEpisode CreateInteractiveVideoEpisode(AuthoringAsset asset)
        {
            ...
            AddNodes(
                ...
                Node(
                    ...
                    "QTE：挣脱黑影",
                    NodeKind.Logic,
                    (LogicCommandCodec.LogicIdParameter, "sample.qte"),
                ...
                Node(
                    ...
                    "开启检票门事件",
                    NodeKind.Logic,
                    (LogicCommandCodec.LogicIdParameter, "sample.unlock"),
            ...
            AddEdges(
                ...
                Edge("edge_interactive_qte_success_unlock", "interactive_qte_success", "completed", "继续", TargetNode("interactive_unlock_parallel")),
                Edge("edge_interactive_qte_fail_unlock", "interactive_qte_fail", "completed", "继续", TargetNode("interactive_unlock_parallel")),
            ...
            AddLayout(
                ...
                ("interactive_unlock_parallel", 1800f, 180f),
                (InteractiveUnlockVideoId, 2060f, 40f),
                ("interactive_unlock_wait", 2060f, 260f),
                ("interactive_unlock", 2300f, 260f),
                ("interactive_unlock_success", 2540f, 180f),
                ("interactive_unlock_fail", 2540f, 300f));
            return episode;
        }
        ...
        private static bool HasInteractiveVideoSample(AuthoringAsset asset)
        {
            ...
            return episode != null &&
                   FindNode(episode, "interactive_qte")?.NodeKind == NodeKind.Logic &&
                   FindNode(episode, "interactive_unlock")?.NodeKind == NodeKind.Logic &&
