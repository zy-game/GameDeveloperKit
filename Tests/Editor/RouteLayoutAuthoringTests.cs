...
namespace GameDeveloperKit.Tests
{
    public sealed class RouteLayoutAuthoringTests
    {
        ...
        public void RouteMutation_WhenExistingLayoutIsInvalid_ReturnsInvalidLayoutWithoutTopologyWrites()
        {
            ...
            var episodeCount = volume.Chapters.Count;
            ...
            Assert.AreEqual(episodeCount, volume.Chapters.Count);
        ...
        private AuthoringAsset Asset()
        {
            ...
            asset.EntryChapterId = episode.ChapterId;
            return asset;
        }

        private static AuthoringChapter Episode()
        {
