...
namespace RenderHeads.Media.AVProVideo.Editor
{
	...
	public static class EditorHelper
	{
		...
		internal class IMGUI
		{
			...
			internal static void DrawSectionColored_TrialUpgrade(string name, ref bool isExpanded, System.Action action, Color boxbgcolor, Color bgcolor, Color color)
			{
				GUI.color = Color.white;
...
*/
				...
				GUILayout.BeginVertical("box");
					...
					//
					if (GUILayout.Button(name, buttonStyle/*, EditorStyles.toolbarButton*/) )
					{
