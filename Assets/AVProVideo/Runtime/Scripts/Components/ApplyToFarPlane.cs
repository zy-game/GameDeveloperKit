...
namespace RenderHeads.Media.AVProVideo
{
	...
	public sealed class ApplyToFarPlane : ApplyToBase
	{
		...
		private void OnDestroy()
		{
			...
			{
				DestroyImmediate(_renderedObject);
			}
		...
		*/
		...
		protected override void OnEnable()
		{
			...
			const string RenderedObjectName = "AVPro Video Far Plane";
			if (_renderedObject == null)
			{
				_renderedObject = GameObject.Find(RenderedObjectName);
			}
			...
			{
				_renderedObject = new GameObject(RenderedObjectName);
