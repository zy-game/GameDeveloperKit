...
#pragma warning restore
		...
		// RBN NOTE (2026-06-05):
		// - strongly discouraged to use scripting defines for serialized fields like this as unity
		//   does some funky buisness with them when switching build platform ( if not done properly 
		//   ( like when building asset bundles ) this can cause issues with the wrong values being included
		//   or failing alltogether ).
		//#if UNITY_STANDALONE_WIN || (UNITY_EDITOR_WIN && !(UNITY_IOS || UNITY_TVOS || UNITY_VISIONOS || UNITY_ANDROID || UNITY_OPENHARMONY || UNITY_WEBGL))
		...
		//#endif
		[SerializeField] private int AudioOutputMode = 0; // Update to int to make it switchable between the different modes
...
//#if UNITY_STANDALONE_WIN
		...
		{
			get { return (Windows.AudioOutput)AudioOutputMode; }
			set { AudioOutputMode = (int)value; PlatformOptionsWindows._audioMode = value; CreateAudioComponents(); }
		}
#elif UNITY_WSA_10_0
		public WindowsUWP.AudioOutput audioOutputModeAVPro
		{
			get { return (WindowsUWP.AudioOutput)AudioOutputMode; }
			set { AudioOutputMode = (int)value; PlatformOptionsWindowsUWP._audioMode = value; CreateAudioComponents(); }
		}
#else
		public PlatformOptions.AudioMode audioOutputModeAVPro
		{
			get
			{
				return (PlatformOptions.AudioMode)AudioOutputMode;
			}
#if UNITY_ANDROID
			set { AudioOutputMode = (int)value; PlatformOptionsAndroid.audioMode = value; CreateAudioComponents(); }
#elif UNITY_OPENHARMONY
			set { AudioOutputMode = (int)value; PlatformOptionsOpenHarmony.audioMode = value; CreateAudioComponents(); }
#elif UNITY_WEBGL
			set { AudioOutputMode = (int)value; PlatformOptionsWebGL.audioMode = value; CreateAudioComponents(); }
#elif UNITY_IOS
			set { AudioOutputMode = (int)value; PlatformOptions_iOS.audioMode = value; CreateAudioComponents(); }
#elif UNITY_STANDALONE_OSX
			set { AudioOutputMode = (int)value; PlatformOptions_macOS.audioMode = value; CreateAudioComponents(); }
#elif UNITY_TVOS
			set { AudioOutputMode = (int)value; PlatformOptions_tvOS.audioMode = value; CreateAudioComponents(); }
#elif UNITY_VISIONOS
			set { AudioOutputMode = (int)value; PlatformOptions_visionOS.audioMode = value; CreateAudioComponents(); }
#endif
		}
#endif
...
//#if UNITY_STANDALONE_WIN
		...
		/// <summary>
		/// Initialises the Media Player, to start being able to play
		/// Will Create the base media player and initialize it
		/// </summary>
		public void Prepare()
		{
			// Call to OpenMedia, if Control is null it will call initialise it for us, other wise will prepare the media
			OpenMedia(false);
		}
...
// editor no longer exists
		...
		void VideoPlayertoAVProConversion()
		{
            ...
            switch (player.audioOutputMode)
			{
				case UnityEngine.Video.VideoAudioOutputMode.None:
					audioOutputModeAVPro = Windows.AudioOutput.None;
					AudioOutputMode = (int)Windows.AudioOutput.None;
					break;
				case UnityEngine.Video.VideoAudioOutputMode.AudioSource:
					audioOutputModeAVPro = Windows.AudioOutput.Unity;
					AudioOutputMode = (int)Windows.AudioOutput.Unity;
					CreateAudioComponents();
					break;
				case UnityEngine.Video.VideoAudioOutputMode.Direct:
				case UnityEngine.Video.VideoAudioOutputMode.APIOnly:
					audioOutputModeAVPro = Windows.AudioOutput.System;
					AudioOutputMode = (int)Windows.AudioOutput.System;
					break;
			}
#elif UNITY_WSA_10_0
			switch (player.audioOutputMode)
			{
				case UnityEngine.Video.VideoAudioOutputMode.None:
					audioOutputModeAVPro = WindowsUWP.AudioOutput.None;
					AudioOutputMode = (int)WindowsUWP.AudioOutput.None;
					break;
				case UnityEngine.Video.VideoAudioOutputMode.AudioSource:
					audioOutputModeAVPro = WindowsUWP.AudioOutput.Unity;
					AudioOutputMode = (int)WindowsUWP.AudioOutput.Unity;
					CreateAudioComponents();
					break;
				case UnityEngine.Video.VideoAudioOutputMode.Direct:
				case UnityEngine.Video.VideoAudioOutputMode.APIOnly:
					audioOutputModeAVPro = WindowsUWP.AudioOutput.System;
					AudioOutputMode = (int)WindowsUWP.AudioOutput.System;
					break;
			}
#elif UNITY_ANDROID || UNITY_IOS || UNITY_STANDALONE_OSX || UNITY_TVOS || UNITY_VISIONOS
			switch (player.audioOutputMode)
			{
				case UnityEngine.Video.VideoAudioOutputMode.None:
					audioOutputModeAVPro = PlatformOptions.AudioMode.SystemDirect;
					AudioOutputMode = (int)PlatformOptions.AudioMode.SystemDirect;
					break;
				case UnityEngine.Video.VideoAudioOutputMode.AudioSource:
					audioOutputModeAVPro = PlatformOptions.AudioMode.Unity;
					AudioOutputMode = (int)PlatformOptions.AudioMode.Unity;
					CreateAudioComponents();
					break;
				case UnityEngine.Video.VideoAudioOutputMode.Direct:
				case UnityEngine.Video.VideoAudioOutputMode.APIOnly:
