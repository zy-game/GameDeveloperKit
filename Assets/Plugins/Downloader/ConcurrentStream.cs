...
namespace Downloader
{
    ...
    {
        private readonly SemaphoreSlim _queueConsumerLocker = new(0);
        private readonly ManualResetEventSlim _completionEvent = new(true);
        private readonly ManualResetEventSlim _stopWriteNewPacketEvent = new(true);
        private readonly ConcurrentBag<Packet> _inputBag = new();
        ...
        public long MaxMemoryBufferBytes
        {
            ...
            set => _maxMemoryBufferBytes = value <= 0 ? long.MaxValue : value;
        }
