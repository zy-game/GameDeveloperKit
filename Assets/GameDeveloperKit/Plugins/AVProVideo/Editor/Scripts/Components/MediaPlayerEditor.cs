...
namespace RenderHeads.Media.AVProVideo.Editor
{
	...
	public partial class MediaPlayerEditor : UnityEditor.Editor
	{
		...
		private void ShowSupportWindowButton()
		{
			...
			if (GUILayout.Button("Click here for <b>Help & Support</b>", buttonStyle, GUILayout.Height(40.0f)) )
			{
				SupportWindow.Init();
			}
		...
		private void ShowImportantMessages()
		{
			...
			if (_isTrialVersion)
			{
				...
				EditorHelper.IMGUI.DrawSectionColored_TrialUpgrade("- AVPRO VIDEO -\nTRIAL VERSION", ref _expandSectionTrial, DrawTrialMessage, Color.blue, Color.black, Color.red);
			}
		...
		private void DrawTrialMessage()
		{
			...
			EditorGUILayout.BeginVertical(GUI.skin.box);
				...
				GUILayout.Label("The free trial version is watermarked.  Upgrade to the full package to remove the watermark.", EditorStyles.wordWrappedLabel);
				...
				EditorGUILayout.BeginVertical();
					...
					EditorGUILayout.BeginHorizontal();
						...
						GUILayout.Label(icon, GUILayout.Width(fButtonHeight), GUILayout.Height(fButtonHeight));
						if (GUILayout.Button("<b>Upgrade Now</b> - Core Mobile Edition", richButton, GUILayout.Width(fButtonWidth), GUILayout.Height(fButtonHeight), GUILayout.ExpandWidth(false)) )
						{
					...
					GUILayout.Space(fSpaceH);

					EditorGUILayout.BeginHorizontal();
						GUILayout.FlexibleSpace();
						GUILayout.Label(icon, GUILayout.Width(fButtonHeight), GUILayout.Height(fButtonHeight));
						if (GUILayout.Button("<b>Upgrade Now</b> - Core Desktop Edition", richButton, GUILayout.Width(fButtonWidth), GUILayout.Height(fButtonHeight), GUILayout.ExpandWidth(false)) )
						{
					...
					EditorGUILayout.BeginHorizontal();
						GUILayout.FlexibleSpace();
						GUILayout.Label(icon, GUILayout.Width(fButtonHeight), GUILayout.Height(fButtonHeight));
						if (GUILayout.Button("<b>Upgrade Now</b> - Core HarmonyOS NEXT Edition", richButton, GUILayout.Width(fButtonWidth), GUILayout.Height(fButtonHeight), GUILayout.ExpandWidth(false)) )
						{
					...
					EditorGUILayout.BeginHorizontal();
						GUILayout.FlexibleSpace();
						GUILayout.Label(icon, GUILayout.Width(fButtonHeight), GUILayout.Height(fButtonHeight));
						if (GUILayout.Button("<b>Upgrade Now</b> - Core Edition", richButton, GUILayout.Width(fButtonWidth), GUILayout.Height(fButtonHeight), GUILayout.ExpandWidth(false)) )
						{
					...
					EditorGUILayout.BeginHorizontal();
						GUILayout.FlexibleSpace();
						GUILayout.Label(icon, GUILayout.Width(fButtonHeight), GUILayout.Height(fButtonHeight));
						if (GUILayout.Button("<b>Upgrade Now</b> - Ultra Edition", richButton, GUILayout.Width(fButtonWidth), GUILayout.Height(fButtonHeight), GUILayout.ExpandWidth(false)) )
						{
