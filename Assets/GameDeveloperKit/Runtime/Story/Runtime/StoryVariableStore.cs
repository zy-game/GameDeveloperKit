...
namespace GameDeveloperKit.Story
{
    ...
    /// 默认剧情变量存储。
    /// </summary>
    public sealed class StoryVariableStore : IStoryVariableStore
    {
        private readonly Dictionary<string, StoryValue> m_Values =
        ...
        public IReadOnlyDictionary<string, StoryValue> Snapshot()
        {
            return new Dictionary<string, StoryValue>(m_Values, StringComparer.Ordinal);
        }
    }
}
